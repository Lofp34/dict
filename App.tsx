...
const App: React.FC = () => {
  ...
  const ai = useMemo(() => {
    try {
      // Récupération de la clé API depuis les variables d'environnement Vite (exposées au client)
      ...
      if (apiKey && apiKey !== 'your_gemini_api_key_here' && apiKey.trim() !== '') {
        ...
        console.warn('Vérifiez que VITE_GEMINI_API_KEY est définie dans vos variables d\'environnement (Vercel et local).');
        return null;
      }
    } catch (error) {
